...
class TVirtualMCRootManager
{
 ...
 public:
  ...
  virtual void Register(
    const char* name, const char* className, void* objAddress) = 0;
  virtual void Register(
    const char* name, const char* className, const void* objAddress) = 0;
  virtual void Fill() = 0;
...
inline void TVirtualMCRootManager::SetDebug(Bool_t debug) { fgDebug = debug; }

inline Bool_t TVirtualMCRootManager::GetDebug() { return fgDebug; }
