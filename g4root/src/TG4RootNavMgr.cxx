...
//______________________________________________________________________________
TG4RootNavMgr::TG4RootNavMgr(
  TGeoManager* geom, TG4RootDetectorConstruction* detConstruction)
  : TObject(),
    fGeometry(geom),
    fNavigator(0),
...
Bool_t TG4RootNavMgr::ConnectToG4()
{
  ...
  if (!fNavigator) {
    Error(
      "ConnectToG4", "Navigator has to be created befor connecting to G4 !!!");
    return kFALSE;
  }
...
//______________________________________________________________________________
void TG4RootNavMgr::Initialize(
  TVirtualUserPostDetConstruction* sdinit, Int_t nthreads)
{
