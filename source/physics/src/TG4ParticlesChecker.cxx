...
{
  /// Print the list of properties selected for checking and the selected
  /// precision
...
{
  /// Check if the given property values in Geant4 and Root for the given
  /// particle are equal within the defined precision. Return true if values
  /// match, otherwise print the property name and values and return false.
