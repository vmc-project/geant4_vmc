...
G4String TG4FieldParameters::FieldTypeName(FieldType field)
{
  ...
  TG4Globals::Exception(
    "TG4FieldParameters", "FieldTypeName:", "Unknown field value.");
  return G4String();
}
...
G4String TG4FieldParameters::EquationTypeName(EquationType equation)
{
  ...
  TG4Globals::Exception(
    "TG4FieldParameters", "EquationTypeName:", "Unknown equation value.");
  return G4String();
}
...
G4String TG4FieldParameters::StepperTypeName(StepperType stepper)
{
  ...
  TG4Globals::Exception(
    "TG4FieldParameters", "StepperTypeName:", "Unknown stepper value.");
  return G4String();
}
...
FieldType TG4FieldParameters::GetFieldType(const G4String& name)
{
  ...
  TG4Globals::Exception(
    "TG4FieldParameters", "GetFieldType:", "Unknown field name.");
  return kMagnetic;
}
...
EquationType TG4FieldParameters::GetEquationType(const G4String& name)
{
  ...
  TG4Globals::Exception(
    "TG4FieldParameters", "GetEquationType:", "Unknown equation name.");
...
StepperType TG4FieldParameters::GetStepperType(const G4String& name)
{
  ...
  TG4Globals::Exception(
    "TG4FieldParameters", "GetStepperType:", "Unknown stepper name.");
