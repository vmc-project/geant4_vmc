    ...
    fRadiatorDescription(0)
{
  ...
  fCreateMagFieldParametersCmd->SetGuidance(
  ...
  fIsLocalMagFieldCmd = new G4UIcmdWithABool("/mcDet/setIsLocalMagField", this);
  fIsLocalMagFieldCmd->SetGuidance(
  ...
  fIsZeroMagFieldCmd = new G4UIcmdWithABool("/mcDet/setIsZeroMagField", this);
  guidance =
  ...
  G4UIcommand* command, G4String newValues)
{
  ...
  if (command == fUpdateMagFieldCmd) {
    ...
    TG4GeometryManager::Instance()->SetIsLocalMagField(
      fIsLocalMagFieldCmd->GetNewBoolValue(newValues));
  }
  else if (command == fIsZeroMagFieldCmd) {
    TG4GeometryManager::Instance()->SetIsZeroMagField(
      fIsZeroMagFieldCmd->GetNewBoolValue(newValues));
  }
