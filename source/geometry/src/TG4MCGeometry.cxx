  ...
  Int_t iaxis, Double_t c0, Int_t numed, Int_t ndvmx)
{
  ...
  ///  size STEP. \n The new volume created will have medium number NUMED. If
  ///  NUMED is 0, NUMED of mother is taken.                                \n
  ///  NDVMX is the expected maximum number of divisions
  ///  (If 0, no protection tests are performed)
  ///  Available only with USE_G3TOG4 option.
...
{
  ///  Geant3 desription: \n
  ///  ================== \n Place a copy of generic volume NAME with user
  ///  number NR inside MOTHER, with its parameters UPAR(1..NP) Available only
  ///  with USE_G3TOG4 option.
