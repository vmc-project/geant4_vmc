...
int main(int argc, char** argv)
{
  ...
  if (verbose == "yes") {
#ifdef USE_GEANT4
    PrintG4Configuration("testE01", g4Geometry, g4PhysicsList, g4SpecialPhysics,
      g4Macro, g4VisMacro, g4Session, rootMacro);
#endif
#ifdef USE_GEANT3
    PrintG3Configuration("testE01", g3Geometry, rootMacro);
#endif
  }
  //
  ...
  Ex01MCApplication* appl =
    new Ex01MCApplication("ExampleE01", "The exampleE01 MC application");
