...
/// Create histograms
  ...
  fHistograms.push_back(new TH1D("3", "Secondary Gamma spectrum", 100, 0., 0.1));
...
/// Finish MC run.
  ...
  cout << " Mean energy deposit in absorber = "
       << fHistograms[0]->GetMean() << " +-"
       << fHistograms[0]->GetRMS()  << "  MeV " << endl;

  cout << " Total number of XTR gammas = "
       << fHistograms[1]->GetEntries() << endl;

  cout << " Total number of all gammas = "
       << fHistograms[2]->GetEntries() << endl;
