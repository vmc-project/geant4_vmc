...
/// \file testE02.cxx
/// \brief The Geant4 VMC example E02 test application
///
...
int main(int argc, char** argv)
{
  ...
  if (verbose == "yes") {
#ifdef USE_GEANT4
    PrintG4Configuration("testE02", g4Geometry, g4PhysicsList, g4SpecialPhysics,
      g4Macro, g4VisMacro, g4Session, rootMacro);
#endif
#ifdef USE_GEANT3
    PrintG3Configuration("testE02", g3Geometry, rootMacro);
#endif
  }
  //
  ...
  Ex02MCApplication* appl =
    new Ex02MCApplication("ExampleE02", "The exampleE02 MC application");
