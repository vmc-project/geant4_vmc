...
int main(int argc, char** argv)
{
  ...
  if ( verbose == "yes" ) {
    ...
    PrintG4Configuration(
      "testGarfield", g4Geometry, g4PhysicsList, g4SpecialPhysics,
      g4Macro, g4VisMacro, g4Session, rootMacro);
#endif
#ifdef USE_GEANT3
    PrintG3Configuration(
      "testGarfield", g3Geometry, rootMacro);
#endif
  }
  //
  ...
  Garfield::RunConfiguration* runConfiguration 
    = new Garfield::RunConfiguration(g4Geometry, g4PhysicsList, g4SpecialPhysics);
