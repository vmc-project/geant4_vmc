...
/// \file testE05.cxx
/// \brief The Geant4 VMC example E05 test application
///
...
int main(int argc, char** argv)
{
  ...
  if ( verbose == "yes" ) {
    ...
    PrintG4Configuration(
      "testE05", g4Geometry, g4PhysicsList, g4SpecialPhysics,
      g4Macro, g4VisMacro, g4Session, rootMacro);
#endif
#ifdef USE_GEANT3
    PrintG3Configuration(
      "testE05", g3Geometry, rootMacro);
#endif
  }
  //
  ...
  Ex05RunConfiguration* runConfiguration 
    = new Ex05RunConfiguration(g4Geometry, g4PhysicsList, g4SpecialPhysics);
